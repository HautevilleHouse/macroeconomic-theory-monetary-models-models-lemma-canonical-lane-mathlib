...
def sourceRepository : String := "macroeconomic-theory-monetary-models-models-lemma-canonical-lane"
def sourceDescription : String := "Macroeconomic Theory Monetary Models Models Lemma"
def sourceTheoremBoundary_claimBoundary : String := "classical boundary carried"
